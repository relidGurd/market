...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    recommendations: Schema.Attribute.Component<'page.accordion', false>;
...
export interface ApiMainPageMainPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mainList: Schema.Attribute.DynamicZone<
      [
        'page.info-card',
        'page.accordion',
        'page.tab',
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    components: Schema.Attribute.DynamicZone<
      ['page.tab', 'page.special-offer', 'page.info-card', 'page.accordion']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    salePercent: Schema.Attribute.Integer &
      ...
      >;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    tab: Schema.Attribute.Component<'page.tab-item', true>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
